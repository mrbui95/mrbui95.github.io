    ...
    "elements": [
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goals": "0.42",
                "expected_assists": "0.04",
                "expected_goal_involvements": "0.46",
                "expected_goals_conceded": "1.12",
                "total_points": 8,
                "in_dreamteam": False
            },
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goals": "1.12",
                "expected_assists": "0.02",
                "expected_goal_involvements": "1.14",
                "expected_goals_conceded": "0.40",
                "total_points": 8,
                "in_dreamteam": False
            },
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goal_involvements": "0.36",
                "expected_goals_conceded": "1.49",
                "total_points": 2,
                "in_dreamteam": False
            },
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goals": "0.95",
                "expected_assists": "0.04",
                "expected_goal_involvements": "0.99",
                "expected_goals_conceded": "0.43",
                "total_points": 8,
                "in_dreamteam": False
            },
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goal_involvements": "0.84",
                "expected_goals_conceded": "0.47",
                "total_points": 3,
                "in_dreamteam": False
            },
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goals": "0.71",
                "expected_assists": "0.15",
                "expected_goal_involvements": "0.86",
                "expected_goals_conceded": "0.47",
                "total_points": 14,
                "in_dreamteam": True
            },
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goals": "1.19",
                "expected_assists": "0.03",
                "expected_goal_involvements": "1.22",
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goal_involvements": "0.77",
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goals": "0.27",
                "expected_assists": "0.16",
                "expected_goal_involvements": "0.43",
                "expected_goals_conceded": "0.25",
                "total_points": 2,
                "in_dreamteam": False
            },
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goals": "1.04",
                "expected_assists": "0.12",
                "expected_goal_involvements": "1.16",
                "expected_goals_conceded": "1.89",
                "total_points": 5,
                "in_dreamteam": False
            },
        ...
        },
        {
            ...
            "stats": {
                ...
                "expected_goals": "0.30",
                "expected_assists": "0.02",
                "expected_goal_involvements": "0.32",
                "expected_goals_conceded": "0.25",
                "total_points": 1,
                "in_dreamteam": False
            },
...
data = {
    'active_chip': None,
    'automatic_subs': [],
    'entry_history': {'event': 1, 'points': 54, 'total_points': 54, 'rank': 1460724, 'rank_sort': 1522527, 'overall_rank': 1460723, 'percentile_rank': 20, 'bank': 0, 'value': 1000, 'event_transfers': 0, 'event_transfers_cost': 0, 'points_on_bench': 3},
    'picks': [
        {'element': 235, 'position': 1, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': False},
        {'element': 311, 'position': 2, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': False},
        {'element': 369, 'position': 3, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': False},
        {'element': 395, 'position': 4, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': False},
        {'element': 495, 'position': 5, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': False},
        {'element': 9, 'position': 6, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': False},
        {'element': 17, 'position': 7, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': False},
        {'element': 317, 'position': 8, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': False},
        {'element': 351, 'position': 9, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': True},
        {'element': 401, 'position': 10, 'multiplier': 2, 'is_captain': True, 'is_vice_captain': False},
        {'element': 82, 'position': 11, 'multiplier': 1, 'is_captain': False, 'is_vice_captain': False},
        {'element': 445, 'position': 12, 'multiplier': 0, 'is_captain': False, 'is_vice_captain': False},
        {'element': 80, 'position': 13, 'multiplier': 0, 'is_captain': False, 'is_vice_captain': False},
        {'element': 309, 'position': 14, 'multiplier': 0, 'is_captain': False, 'is_vice_captain': False},
        {'element': 461, 'position': 15, 'multiplier': 0, 'is_captain': False, 'is_vice_captain': False}
    ]
}
...
def GetCaptionPoint(player_data):
    ...
    print(vice_captain_pick[0]['element'])
    vice_captain_id = vice_captain_pick[0]['element']
    vice_captain_multi = vice_captain_pick[0]['multiplier']
